// Package mail implements the Mailer port against an SMTP server.
package mail
...
// SMTP delivers transactional email.
type SMTP struct{ cfg Config }

// New returns nil when host or From is empty (mailer disabled).
