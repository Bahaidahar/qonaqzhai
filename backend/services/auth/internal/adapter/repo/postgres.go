// Package repo holds the PostgreSQL persistence adapters for the auth service.
package repo
...
// Migrations holds the auth service's embedded SQL migrations.
//
//go:embed all:migrations
var Migrations embed.FS

// Open opens a Postgres connection with sensible pool defaults and applies all
// pending migrations.
...
// Migrate applies all embedded *.up.sql migrations in lexical order. Already
