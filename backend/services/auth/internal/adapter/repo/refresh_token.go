...
func NewRefreshTokenRepo(db *sql.DB, idGen ports.IDGen) *RefreshTokenRepo {
...
// FindActiveByHash returns the active refresh token matching hash at the given
// clock time.
...
var _ ports.RefreshTokenRepo = (*RefreshTokenRepo)(nil)
