...
func NewPasswordResetRepo(db *sql.DB, idGen ports.IDGen) *PasswordResetRepo {
...
// FindByHash returns the token row matching hash. Validity is checked by
// caller.
...
var _ ports.PasswordResetRepo = (*PasswordResetRepo)(nil)
